...
public class ArabicRomanNumeralsTest {
    ...
    public void testConvert() {
        ...
        assertEquals("CDXLIV", ArabicRomanNumerals.convert(444));
        assertEquals("CMXCIX", ArabicRomanNumerals.convert(999)); // 999 -
        assertEquals("MMMCMXCIX", ArabicRomanNumerals.convert(3999));
    }
}